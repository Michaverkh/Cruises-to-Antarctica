...
/* harmony import */ var _modules_trips__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/trips */ "./js/modules/trips.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_trips__WEBPACK_IMPORTED_MODULE_3__["renderCruises"])(_modules_trips__WEBPACK_IMPORTED_MODULE_3__["tripList"]);
  Object(_modules_map__WEBPACK_IMPORTED_MODULE_4__["initMap"])(); // Modules
  // ---------------------------------
...
var logo = document.querySelector(".page-header__img");
...
/* harmony import */ var _leaflet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./leaflet */ "./js/modules/leaflet.js");
/* harmony import */ var _leaflet__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_leaflet__WEBPACK_IMPORTED_MODULE_0__);
// 59.93859, 30.32269
...
var initMap = function initMap() {
  ...
  var MainMarker = L.marker(HOME_POSITION, {
    draggable: true,
    icon: mainPinIcon
  });
...
/*!*****************************!*\
  !*** ./js/modules/trips.js ***!
  \*****************************/
/*! exports provided: tripList, renderCruises */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tripList", function() { return tripList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderCruises", function() { return renderCruises; });
var tripList = [{
  Id: 0,
  name: "Астория",
...
var tripListContainer = document.querySelector('.upcoming-cruises__list');
var tripTemplate = document.querySelector('#upcoming-cruises-template').content.querySelector('.cruis-item');
var renderCruises = function renderCruises(data) {
  data.forEach(function (trip) {
    var tripElement = tripTemplate.cloneNode(true);
    var tripNames = tripElement.querySelectorAll('.cruis-item__header');
    tripNames.forEach(function (name) {
      return name.textContent = "\u041A\u0440\u0443\u0438\u0437  \u201C".concat(trip.name, "\u201D");
    });
    ...
    tripElement.querySelector('.cruis-item__text--duration').textContent = "".concat(trip.duration, " \u0434\u043D\u0435\u0439");
    tripElement.querySelector('.cruis-item__text--price').textContent = "\u043E\u0442 ".concat(trip.price, " $");
